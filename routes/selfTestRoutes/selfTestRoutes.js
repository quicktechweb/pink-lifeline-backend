...
import {
  ...
  deleteSelfTestQuestionById2,
  updateSelfTestAnswerV2,
  getRecommendedDoctors,
} from '../../controllers/SelfTest/selfTestSteps.js';
import {
  addQuestion,
  deleteQuestion,
  getAllQuestions,
  getQuestionsByStep,
  updateQuestion,
} from '../../controllers/SelfTest/selfTestQuestions.js';
import {
  addAnswer,
  deleteAnswer,
  ...
  updateAnswer,
  getAllAnswers,
} from '../../controllers/SelfTest/selfTestAnswers.js';
...
router.put(
  '/v2/update-self-test-answer/:stepId/:answerId',
  updateSelfTestAnswerV2
);

router.delete(
  '/v2/delete-self-test-question/:stepId/:questionId',
  deleteSelfTestQuestionById2
);
...
router.post(
  '/v2/doctor-recommendations/:userId',
  isUserExist,
  getRecommendedDoctors
);
