...
import {
  recordPeriodLog,
  getPeriodData,
  getPeriodBasicInsights,
  previousPeriodsInfo,
  addDailyNote,
  getPeriodBasicInsightsV2,
...
import {
  ...
  recordPeriodCurrent,
  recordPeriodEnd,
} from '../../controllers/Period/trackPeriod/trackPeriod2.js';
...
router.get(
  '/v1/get-period-basics-insights/:userId',
  isUserExist,
  getPeriodBasicInsights
);
router.get(
  '/v2/get-period-basics-insights/:userId',
  isUserExist,
  getPeriodBasicInsightsV2
);
