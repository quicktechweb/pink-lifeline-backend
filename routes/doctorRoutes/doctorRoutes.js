...
import {
  ...
  setDoctorScore,
  enableDisableWeekDay,
  getDailySchedule,
  removeExceptionalDay,
  getTotalCommentsPatients,
  ...
  deleteUser,
  updateRoleByAdmin,
  getDailyScheduleWithAppointments,
  getDoctorDetailsWithSchedule,
  getConfirmedAppointments,
  getCompletedAppointments,
  markNotificationAsRead,
  getAllNotificationsToAll,
...
router.get(
  '/get-doctor-by-registration-number/:doctorRegistrationNumber',
  getDoctorByRegistrationNumber
);
...
router.delete(
  '/remove-doctor-daily-schedule/:userId',
  isDoctor,
  removeSchedule
);
router.patch(
  '/enable-disable-week-day/:userId',
  isDoctor,
  enableDisableWeekDay
);
router.post(
  '/get-daily-schedule-by-doctor/:userId',
  isDoctor,
  getDailySchedule
);
router.post(
  '/get-doctor-monthly-schedule/:userId',
  isDoctor,
  getDoctorMonthlySchedule
);
router.post('/add-exceptional-day/:userId', isDoctor, addExceptionalSchedule);
router.delete(
  '/remove-exceptional-day/:userId',
  isDoctor,
  removeExceptionalDay
);

router.post(
  '/add-doctor-weekly-schedule/:userId',
  isDoctor,
  addDoctorWeeklySchedule
);

router.get(
  '/get-total-comment-patients/:userId',
  isDoctor,
  getTotalCommentsPatients
);

router.post(
  '/get-daily-doctor-appointments/:userId',
  isDoctor,
  getDailyAppointments
);

router.post(
  '/get-daily-confirmed-appointments-by-doctor/:userId',
  isDoctor,
  getConfirmedAppointments
);
router.post(
  '/get-completed-appointments-by-doctor/:userId',
  isDoctor,
  getCompletedAppointments
);
router.get(
...
router.post(
  '/mark-notification-as-read/:userId',
  isUserExist,
  markNotificationAsRead
);
...
router.post(
  '/reset-password-by-admin/:userId',
  isUserExist,
  updateAdminPassword
);
...
router.post(
  '/get-daily-schedule-appointments/:userId',
  getDailyScheduleWithAppointments
);
router.post(
  '/doctor-details-schedule/:userId',
  isDoctor,
  getDoctorDetailsWithSchedule
);
