...
const topics = ["Healthcare Innovation", "Community Engagement", "Patient Advocacy", "Clinical Best Practices"];
...
async function sendPost(i) {
  ...
  form.append('hashtags', JSON.stringify(["tech", "development", "community", "professional"]));
